...
<body>
		...
		<div class="login">
			<form style="width: 30%; margin-left: 35.5%; font-size: 16px; color: #3A5FCD;" method="post" action="sistema.php">
			...
			<input type="submit" class="btn btn-block btn-primary" name="entrar" value="Entrar">
 			</form>
		</div>
		<br>
		...
		function onSignIn(googleUser) {
			...
			if (user_name !== '') {
				...
				$.post('sistema.php', dados); //Envia a variável para que os dados sejam inseridos no BD
			}
